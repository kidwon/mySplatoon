...
const STRINGS: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    connected: '已连接',
    disconnected: '连接已断开',
    connectFailed: '无法连接服务器，请确认已运行 npm run lan（或 npm run dev:all）',
    lanAddr: '同一局域网的其他设备打开：',
    createRoom: '创建房间',
    joinRoom: '加入',
    codePlaceholder: '房间码',
    roomCode: '房间码',
    ...
    escHintOnlineTouch: '点击右上角菜单可返回（对局计时不会暂停）',
    backToRoom: '返回房间',
    waitingResult: '等待结算…',
    ping: '延迟',
  ...
  ja: {
    ...
    connectFailed: 'サーバーに接続できません（npm run lan または npm run dev:all を確認）',
    lanAddr: '同じLANの他の端末はこちらを開く：',
    createRoom: 'ルーム作成',
    joinRoom: '参加',
    ...
    escHintOnlineTouch: '右上のメニューで戻る（タイマーは止まりません）',
    backToRoom: 'ルームへ戻る',
  ...
  en: {
    ...
    escHintTouch: 'Tap the menu button (top right) to pause / go back',
    ...
    connectFailed: 'Cannot reach server (run npm run lan or npm run dev:all)',
    lanAddr: 'Other devices on this LAN open:',
    ...
    escHintOnlineTouch: 'Tap the menu button (top right) to go back (the clock keeps running)',
